// npx cap add android 직후에 한 번 실행: 권한, 알림 아이콘, 뒤로가기, 설정 열기
...
// 2) 안드로이드 13+ 예측 뒤로가기 끄기 (켜져 있으면 앱이 뒤로가기 신호를 못 받음)
